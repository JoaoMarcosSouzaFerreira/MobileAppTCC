...
void ui_event_SplashScreen(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_SCREEN_LOADED) {
        _ui_screen_change(&ui_ParametrosEspRemoto, LV_SCR_LOAD_ANIM_MOVE_LEFT, 500, 8000, &ui_ParametrosEspRemoto_screen_init);
    }
}
...
void ui_SplashScreen_screen_init(void)
{
    ...
    lv_label_set_text(ui_Label3, "Seja bem-vindo !");
